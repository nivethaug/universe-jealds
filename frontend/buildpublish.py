...
def restart_pm2(project_name: str = None):
    ...
    Args:
        project_name: Project name (uses universe-jealds placeholder by default)
    """
    print("\n" + "="*50)
    print("PM2 RESTART")
    print("="*50)
    ...
    if not project_name:
        project_name = "universe-jealds"
    
    return run(f"sudo pm2 restart universe-jealds-frontend")
...
def main():
    ...
    if not args.no_restart and success:
        restart_pm2()  # Uses universe-jealds placeholder
        reload_nginx()
