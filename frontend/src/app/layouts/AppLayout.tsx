...
const mainNavItems = [
  ...
  { name: 'Ideaforge', href: '/', icon: LayoutDashboard },
  { name: 'Worldsofknowledge', href: '/worldsofknowledge', icon: LayoutDashboard },
  { name: 'Memoryconstellations', href: '/memoryconstellations', icon: LayoutDashboard },
  { name: 'Grandarchive', href: '/grandarchive', icon: LayoutDashboard },
];
